module github.com/tta-lab/lenos
...
require (
	...
	github.com/tta-lab/temenos v0.9.1-0.20260525133407-6ce2d0c5ed04
	...
	mvdan.cc/sh/v3 v3.13.1-lensh.2
)
...
replace mvdan.cc/sh/v3 => github.com/tta-lab/sh/v3 v3.13.1-lensh.2
