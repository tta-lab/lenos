...
// Copyable is an item that can provide clipboard text distinct from its
// compact rendered form.
...
func ExtractMessageItems(sty *styles.Styles, msg *message.Message, showThinking bool) []MessageItem {
	switch msg.Role {
	case message.User:
