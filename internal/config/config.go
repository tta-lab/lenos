...
type Options struct {
	...
	MessageBlockPrefill       bool         `json:"message_block_prefill,omitempty" jsonschema:"description=Enable hardcoded native assistant response prefill for providers that support prefix completion"`
}
