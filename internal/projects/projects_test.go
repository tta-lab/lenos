...
func TestRegisterAndList(t *testing.T) {
	...
	t.Setenv("LENOS_GLOBAL_DATA", filepath.Join(tmpDir, "lenos"))

	// Test registering a project
	err := Register("/home/user/project1", "/home/user/project1/.lenos")
	if err != nil {
	...
	if projects[0].DataDir != "/home/user/project1/.lenos" {
		t.Errorf("Expected data_dir /home/user/project1/.lenos, got %s", projects[0].DataDir)
	}

	// Register another project
	err = Register("/home/user/project2", "/home/user/project2/.lenos")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestRegisterUpdatesExisting(t *testing.T) {
	...
	err = Register("/home/user/project1", "/home/user/project1/.lenos-new")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/home/user/project1/.lenos-new" {
...
func TestProjectsFilePath(t *testing.T) {
	...
	expected := filepath.Join(tmpDir, "lenos", "projects.json")
...
func TestRegisterWithParentDataDir(t *testing.T) {
	...
	// Register a project where .lenos is in a parent directory.
	// e.g., working in /home/user/monorepo/packages/app but .lenos is at /home/user/monorepo/.lenos
	err := Register("/home/user/monorepo/packages/app", "/home/user/monorepo/.lenos")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/home/user/monorepo/.lenos" {
		t.Errorf("Expected data_dir /home/user/monorepo/.lenos, got %s", projects[0].DataDir)
	}
}
...
func TestRegisterWithExternalDataDir(t *testing.T) {
	...
	// Register a project where .lenos is in a completely different location.
