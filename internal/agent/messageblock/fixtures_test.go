...
func TestMessageBlockFixtureCorpus(t *testing.T) {
	...
	requireFixtureNames(t, seen, []string{
		...
		"bash-same-line-message-looking-text-heredoc-setup",
		"bash-message-looking-text-inside-if",
		"bash-message-looking-text-inside-loop",
		"bash-message-looking-text-inside-function",
		"bash-message-looking-text-inside-command-substitution",
		"bash-message-looking-text-inside-string",
		"bash-message-looking-text-inside-comment",
		"bash-message-looking-text-as-command-word",
